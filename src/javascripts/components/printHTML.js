...
const printHTMl = (divId) => {
  const htmlString = `<div class="jumbotron text-center">
                        <h1 class="display-4">Welcome to Hoggy Hoggy Warts!</h1>
                         <p class="lead"> Stupefy alohomora totalus orchideous inflamarae locomotor momentum
                                          serpensortia totalus. Patronum kedavra legilimens petrificus expecto
                                          banishing expecto patronum arania mobilicorpus petrificus.</p>
                        <hr class="my-4" />
                        <p> Ennervate serpensortia deletrius evanesco imperio funnunculus impedimenta.</p>
                        <div id="button-div">
